...
import { AffiliateRow } from '../component/affiliateRow';
import { InviteAffiliateForm } from '../component/inviteAffiliateForm';
import { SummaryCards } from '../component/summaryCards';
import { SummarySkeleton, AffiliateRowSkeleton } from '../component/skeletons';
        ...
        {!isLoading && affiliates && affiliates.length > 0 && (
          <div className="hidden sm:flex items-center justify-between px-5 py-2 border-b border-[var(--border)] bg-white/[0.01]">
            ...
            <div className="flex items-center gap-6 shrink-0 ml-4">
              ...
              <span className="text-[var(--muted)] text-xs uppercase tracking-wider w-20 text-right">Actions</span>
            </div>
          </div>
        )}
