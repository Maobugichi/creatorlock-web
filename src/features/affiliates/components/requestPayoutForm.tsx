    ...
    <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 space-y-7">
      ...
      {requestSuccess && (
        <div className="rounded-2xl border border-success/20 bg-success/[0.06] px-5 py-4">
          <p className="text-sm font-semibold text-success">Payout requested</p>
      ...
      {payoutError && (
        <div className="rounded-2xl border border-status-exception/20 bg-status-exception/[0.06] px-5 py-4">
          <p className="text-sm font-semibold text-status-exception">Payout failed</p>
          <p className="text-sm text-status-exception/70 mt-0.5">{payoutError}</p>
        </div>
      )}

      <div className="space-y-1">
        <p className="text-xs uppercase tracking-[0.14em] text-muted-foreground">Payout amount</p>
        <p className="font-mono text-2xl sm:text-3xl font-bold text-success truncate">
          {formatNGN(availableCents)}
        </p>
        <p className="text-xs text-muted-foreground">Full available balance</p>
      </div>
