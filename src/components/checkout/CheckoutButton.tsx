  ...
  return (
    <>
      <button
        ...
        type="button"
        className="w-full rounded-xl px-4 py-3.5 font-syne text-sm font-bold text-price-foreground bg-price transition-opacity hover:opacity-90 active:opacity-80"
      >
